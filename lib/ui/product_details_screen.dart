          ...
          StreamBuilder(
            ...
            builder: (BuildContext context ,AsyncSnapshot snapshot){
              ...
              return Padding(
                ...
                child: CircleAvatar(
                  backgroundColor: Colors.blueAccent,
                  child: IconButton(onPressed: ()=>snapshot.data.docs.length==0?addToFavourite():print("Already added"),
                    icon: snapshot.data.docs.length==0? Icon(Icons.favorite_border_outlined,color: Colors.white):Icon(Icons.favorite,color: Colors.white),
                  ),
                ),
              );
